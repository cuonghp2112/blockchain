...
class HttpServer {
    constructor(node, blockchain, operator, miner) {
        ...
        this.app.post('/operator/wallets/:walletId/contracttransactions', (req, res) => {
            let walletId = req.params.walletId;
            let password = req.headers.password;
            ...
            try {
                ...
                let newTransaction = operator.createcontractTransaction(walletId, req.body.fromAddress, req.body.ctAddress, req.body.content, req.body['changeAddress'] || req.body.fromAddress);
        ...
        this.app.use('/home/login',function(req,res){
        ...
        this.app.post('/submit-transaction',(req,res)=>{
            ...
            const fromAddress = projectedWallet.addresses
